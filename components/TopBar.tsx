      ...
      <div className="mx-auto flex w-full max-w-[1320px] flex-wrap items-center justify-between gap-2 px-4">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          <button className="flex items-center gap-1 rounded-[6px] bg-brand-accent px-3 py-1.5 font-medium text-[var(--brand-button-text)] hover:bg-brand-accentDark">
            {registerIconSrc ? (
              <span
                ...
                style={{
                  WebkitMaskImage: `url(${registerIconSrc})`,
                  maskImage: `url(${registerIconSrc})`,
          ...
          <input
            ...
            placeholder="帳號"
            className="w-24 rounded-[6px] border-0 bg-black/50 px-3 py-1.5 text-white placeholder-white/80 outline-none"
          />
          <div className="relative">
            <input
              ...
              placeholder="密碼"
              className="w-24 rounded-[6px] border-0 bg-black/50 px-3 py-1.5 pr-7 text-white placeholder-white/80 outline-none"
            />
            <button
              type="button"
            ...
            >
              {eyeIconSrc ? (
                // SVG icon recolored via CSS mask. JIN's own eye icon is this
                // specific orange (#fd8000, sampled from pc.jin57.cc), not
                // one of the 4 brand tokens.
                <span
                  aria-hidden
                  className="block h-4 w-4 bg-[#fd8000]"
                  style={{
